document.addEventListener("DOMContentLoaded", () => {
  ...
  window.addCoupon = async function () {
    ...
    if (res.ok) {
      Swal.fire({ icon: "success", title: "Coupon Added!", timer: 1500, showConfirmButton: false })
  ...
  window.editCoupon = function (id, code, discount, minAmount, maxAmount, expiryDate) {
    ...
    document.getElementById("expiry").value = new Date(expiryDate).toISOString().split("T")[0];
