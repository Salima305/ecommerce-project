...
document.addEventListener("DOMContentLoaded", () => {
  ...
  buttons.forEach(btn => {
    btn.addEventListener("click", () => {
      ...
      console.log("category set to:", document.getElementById("editCategory").value);
      ...
      container.innerHTML = "";
      images.forEach(img => {
//       container.innerHTML += `<img src="/uploads/${img}" width="60" style="border-radius:4px; margin:2px;">`;
// });
   container.innerHTML += `
